      ...
      <table className="w-full border-collapse border border-gray-400 dark:border-gray-600 text-sm">
        <thead className="bg-gray-100 dark:bg-gray-700">
          <tr>
            ...
            <th className="border border-gray-300 dark:border-gray-600 p-2 font-semibold text-left w-2/5">ITEMS</th>
        ...
        <tbody>
          {items.map((item, index) => (
            <tr key={index} className={index % 2 === 0 ? "bg-white dark:bg-gray-800" : "bg-gray-50 dark:bg-gray-700/50"}>
              ...
              <td className="border border-gray-300 dark:border-gray-600 p-1">{item.name}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-1 text-center">{item.hsn}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-1 text-right">{item.qty}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-1 text-right">{Number(item.rate).toFixed(2)}</td>
              <td className="border border-gray-300 dark:border-gray-600 p-1 text-right">{Number(item.amount).toFixed(2)}</td>
            </tr>
          ))}
          {emptyRows}
        </tbody>
        <tfoot className="bg-gray-100 dark:bg-gray-700 font-bold">
          <tr>
            ...
            <td className="border border-gray-300 dark:border-gray-600 p-2 text-right">{subTotal.toFixed(2)}</td>
          </tr>
        </tfoot>
      </table>
    </div>
